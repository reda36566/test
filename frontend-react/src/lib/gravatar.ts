const md5 = (input: string) => {
  ...
  const FF = (a: number, b: number, c: number, d: number, x: number, s: number, ac: number) => {
    let temp = addUnsigned(a, addUnsigned(addUnsigned(F(b, c, d), x), ac));
    temp = addUnsigned(rotateLeft(temp, s), b);
    return temp;
  };
  const GG = (a: number, b: number, c: number, d: number, x: number, s: number, ac: number) => {
    let temp = addUnsigned(a, addUnsigned(addUnsigned(G(b, c, d), x), ac));
    temp = addUnsigned(rotateLeft(temp, s), b);
    return temp;
  };
  const HH = (a: number, b: number, c: number, d: number, x: number, s: number, ac: number) => {
    let temp = addUnsigned(a, addUnsigned(addUnsigned(H(b, c, d), x), ac));
    temp = addUnsigned(rotateLeft(temp, s), b);
    return temp;
  };
  const II = (a: number, b: number, c: number, d: number, x: number, s: number, ac: number) => {
    let temp = addUnsigned(a, addUnsigned(addUnsigned(I(b, c, d), x), ac));
    temp = addUnsigned(rotateLeft(temp, s), b);
    return temp;
  };
...
export const getGravatarUrl = (email: string) => {
  ...
  return `https://www.gravatar.com/avatar/${md5(normalized)}?d=identicon&s=256`;
};
